...
l'&eacute;valuation des frames (cf. le tutorial sur la <?php what("cr&eacute;ation d'un node de 'Lookat' sous Nuke", "/2D_LookAt_in_Nuke");?>).</P>
...
le tout dans un <?php py("set", "https://docs.python.org/2/library/stdtypes.html#set");?>, afin que cela reste le plus l&eacute;ger
possible, &agrave; noter que les sets en python <?php py("n'ayant pas d'index", "https://docs.python.org/2/library/sets.html");?>,
...
<dt id="30"></dt><h1>Cr&eacute;ation des n&oelig;uds</h1>
<P>Nous allons maintenant attaquer le gros
...
complexe&nbsp;!</P>
<P>Comme &ccedil;a&nbsp;;</P>
<?php addImage("00.png", "Aper&ccedil;u de notre objectif", 201);?>
...
<P>
<?php
addTip("La petite astuce pour acc&egrave;der &agrave;
tout les attributs modifiables de votre n&oelig;ud Nuke, (ces
attributs se nomment des <B>knobs</B>), il suffit de laisser la
...
pour acc&egrave;der &agrave; cet attribut&nbsp;;");
addImage("01.gif", "Comment conna&icirc;tre le nom de nos knobs");
?>
...
<BR><P>
<?php
addNote("L'attribut '<B>postage_stamp</B><SPAN STYLE='font-weight: normal'>'</SPAN>
...
<dt id="40"></dt><h1>R&eacute;glages visuels</h1>
<P>
...
<dt id="50"></dt><h1>Assemblage final</h1>
<P>
...
<UL>
	...
	<UL>
		...
		<I>Remove</I>
		<LI>on cr&eacute;e un n&oelig;ud de
		<I>Dot</I> que l'on replace sous le n&oelig;ud de <I>Remove</I>
...
<?php addImage("02.png", "Ce qu'on obtient avec l'image d'exemple");?>
...
<dt id="60"></dt><h1>La cerise sur le g&acirc;teau</h1>
<P>
...
Nuke. <?php what("Voici la doc", "http://www.nukepedia.com/reference/Tcl/group__tcl__builtin.html");?> o&ugrave; vous pouvez faire vos courses, selon vos besoin
...
<?php addImage("03.jpg", "Même en s&eacute;lectionnant un n&oelig;ud enfant, le script trouvera le Read");?>
...
<?php addImage("04.jpg", "R&eacute;sultat final");?>
